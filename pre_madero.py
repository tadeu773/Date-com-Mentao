...
def pre_madero(screen):
    clock = pygame.time.Clock()

    # Carrega o fundo usando caminho absoluto
    background_path = path.join(FUNDOS_DIR, 'madero.jpg')
    ...
    if progresso_jogador["madero completo"]:
        narrativas.cena_pos_madero(sair_para_madero, sair_para_madero)
    else:
        narrativas.criar_cena_inicial_pre_madero(sair_para_madero)
